...
with open("D:/Anaconda3/envs/py368/Lib/site-packages/Flask/computer2021/web-deep-learning-classifier-master/src/config.yaml", 'r') as stream:
...
model = load_model('D:/Anaconda3/envs/py368/Lib/site-packages/Flask/computer2021/web-deep-learning-classifier-master/models')
